...
def process_single_update(db: Session, update: models.GardenUpdate) -> None:
    ...
    try:
        ...
        latest_update.needs_water = overview.get('needs_water', False)
        latest_update.pest_detected = overview.get('pest_detected', False)
        latest_update.low_sunlight = overview.get('low_sunlight', False)
